export function Calendar({
  calendarMonth,
  classCurrentDay = true,
  classActiveDay = false,
  deadlineTask,
  dateControl,
}) {
  const activeDay = classActiveDay ? "_active-day" : "";
  const currentDay = classCurrentDay ? "_current" : "";
  return (
    <div className="calendar__block">
      <div className="calendar__nav">
        <div className="calendar__month">{calendarMonth}</div>
      ...
      <div className="calendar__content">
        ...
        <div className="calendar__cells">
          ...
          <div className={`calendar__cell _cell-day _weekend ${currentDay}`}>
            8
          </div>
          <div className={`calendar__cell _cell-day _weekend ${activeDay}`}>
            9
          </div>
      ...
      <div className="calendar__period">
        <p className="calendar__p date-end">
          {deadlineTask}
          <span className="date-control">{dateControl}</span>.
        </p>
      </div>
    </div>
  );
